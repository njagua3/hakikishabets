...
public class Bet {
    ...
    @Setter
    private Double stake; // Amount of money placed on the bet

    @Setter
    private Double potentialWin; // Amount of money that can be won if the bet succeeds
    ...
    // Constructor to quickly create a bet with all fields
    public Bet(Double stake, Double potentialWin, BetStatus status, LocalDateTime placedAt,
